...
export const QrCodeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5a3 3 0 00-3 3v1.5M17.25 4.5a3 3 0 013 3v1.5M3.75 18a3 3 0 01-3-3V13.5m16.5 1.5a3 3 0 003-3V13.5M3 9h18M3 15h18" />
    </svg>
);